...
class ASVspoof2021_DF_LA_S:
    ...
    PATH_TRAIN_TRL_DA_S         = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_S.txt'
    PATH_TRAIN_TRL_DA_S_wo_speed = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_S_wo_speed.txt'
    PATH_TRAIN_TRL_DA_speed     = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_speed.txt'
    ...
    PATH_DEV_TRL_DA_S           = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_DEV_S.txt'
    PATH_DEV_TRL_DA_S_wo_speed  = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_DEV_S_wo_speed.txt'
    PATH_DEV_TRL_DA_speed       = 'LA/ASVspoof2019_LA_cm_protocols/metadata_with_DA_DEV_speed.txt'
    ...
    def __init__(self, path_train, path_test, path_test_LA, use_dev=True, DA=True, DA_speed=True, codec_S=True, only_speed=False, print_info=False):   
        self.train_set = []
        self.test_set = []
        self.test_set_LA = []
        self.class_weight = []
        ...
        if codec_S:
            trl = os.path.join(path_train, self.PATH_TRAIN_TRL_DA_S)
        if not DA_speed: 
            trl = os.path.join(path_train, self.PATH_TRAIN_TRL_DA_S_wo_speed)
        if only_speed: 
            trl = os.path.join(path_train, self.PATH_TRAIN_TRL_DA_speed)
        ...
        if use_dev:
            ...
            if codec_S: 
                trl_dev = os.path.join(path_train, self.PATH_DEV_TRL_DA_S)
            if not DA_speed: 
                trl_dev = os.path.join(path_train, self.PATH_DEV_TRL_DA_S_wo_speed)
            if only_speed: 
                trl_dev = os.path.join(path_train, self.PATH_DEV_TRL_DA_speed)
