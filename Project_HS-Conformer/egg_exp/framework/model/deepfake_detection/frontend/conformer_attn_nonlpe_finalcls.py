...
from .wenet.transformer.encoder_attn_nonlpe_finalcls import ConformerEncoder
# from wenet.transformer.encoder_attn_nonlpe_finalcls import ConformerEncoder

class ConformerAttn_NonLPE_FinalCLS(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
            ...
            downsample_layer=[1,3],  attn_size=3, input_seq_len=200):

        super(ConformerAttn_NonLPE_FinalCLS, self).__init__()
        ...
        self.conformer_mp = ConformerEncoder(input_size=bin_size, linear_units=linear_units, num_blocks=num_blocks, 
                ...
                downsample_layer=downsample_layer, attn_size=attn_size, input_seq_len=input_seq_len)
...
if __name__ == '__main__':
    ...
    model = ConformerAttn_NonLPE_FinalCLS().cuda()
