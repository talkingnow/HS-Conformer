...
from wenet.transformer.encoder_layer_mp_nonlpe_finalcls import ConformerEncoderLayerMP_NonLPE_FinalCLS
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        self.add_layer_noise = GaussianNoise() if add_layer_noise else torch.nn.Identity()
    ...
    def __init__(
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerMP_NonLPE_FinalCLS(
                    output_size,
                    seq_len,
                    downsample,
