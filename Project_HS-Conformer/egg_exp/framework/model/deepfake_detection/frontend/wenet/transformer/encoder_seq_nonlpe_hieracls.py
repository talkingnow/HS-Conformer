...
from wenet.transformer.encoder_layer_seq_nonlpe_hieracls import ConformerEncoderLayerSeq_NonLPE_HieraCLS
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        convolution_layer_args = (output_size, cnn_module_kernel, activation,
                                  cnn_module_norm, causal, True, False) # bias, except_CLS
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerSeq_NonLPE_HieraCLS(
                    output_size,
                    seq_len,
                    downsample,
