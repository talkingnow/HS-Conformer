...
from wenet.transformer.encoder_layer_gp_nonlpe import ConformerEncoderLayerGP_NonLPE
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        super().__init__(input_size, output_size, attention_heads,
                         ...
                         global_cmvn, use_dynamic_left_chunk, use_cls)
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                downsample = torch.nn.Linear(output_size, 1)
                seq_len = math.ceil( (seq_len * pooling_size) )
            else:
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerGP_NonLPE(
                    output_size,
                    seq_len,
                    downsample,
