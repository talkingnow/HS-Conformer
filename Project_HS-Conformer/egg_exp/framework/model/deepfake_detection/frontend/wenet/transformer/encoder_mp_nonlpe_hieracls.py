...
from wenet.transformer.encoder_layer_mp_nonlpe_hieracls import ConformerEncoderLayerMP_NonLPE_HieraCLS
    ...
    def __init__(
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerMP_NonLPE_HieraCLS(
                    output_size,
                    seq_len,
                    downsample,
