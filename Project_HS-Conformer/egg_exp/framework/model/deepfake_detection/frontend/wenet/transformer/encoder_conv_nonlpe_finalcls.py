...
from wenet.transformer.encoder_layer_conv_nonlpe_finalcls import ConformerEncoderLayerConv_NonLPE_FinalCLS
    ...
    def __init__(
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerConv_NonLPE_FinalCLS(
                    output_size,
                    seq_len,
                    downsample,
