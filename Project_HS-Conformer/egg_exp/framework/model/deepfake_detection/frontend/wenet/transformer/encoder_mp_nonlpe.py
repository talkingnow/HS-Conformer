...
from wenet.transformer.encoder_layer_mp_nonlpe import ConformerEncoderLayerMP_NonLPE
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        self.add_layer_noise = GaussianNoise() if add_layer_noise else nn.Identity()
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        super().__init__(input_size, output_size, attention_heads,
                         ...
                         global_cmvn, use_dynamic_left_chunk, add_layer_noise=add_layer_noise)
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerMP_NonLPE(
                    output_size,
                    seq_len,
                    downsample,
