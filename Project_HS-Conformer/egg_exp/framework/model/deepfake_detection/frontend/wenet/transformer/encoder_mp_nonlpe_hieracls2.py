...
from wenet.transformer.encoder_layer_mp_nonlpe_hieracls2 import ConformerEncoderLayerMP_NonLPE_HieraCLS2
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        self.cnt_cls = len(downsample_layer) + 1
    ...
    def forward(
        ...
        for i in range(len(self.encoders)):
            xs, pos_emb = self.encoders[i](xs, pos_emb, cnt_cls=cnt)
    ...
    def __init__(
        ...
        for i in range(num_blocks):
            if i in downsample_layer: 
                ...
                downsample = None
                seq_len = seq_len
            encoders.append(ConformerEncoderLayerMP_NonLPE_HieraCLS2(
                    output_size,
                    seq_len,
                    downsample,
