...
from .wenet.transformer.encoder_attn_nonlpe import ConformerEncoder
# from wenet.transformer.encoder_attn_nonlpe import ConformerEncoder

class ConformerAttn_NonLPE(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
        ...
        super(ConformerAttn_NonLPE, self).__init__()
...
if __name__ == '__main__':
    ...
    model = ConformerAttn_NonLPE().cuda()
