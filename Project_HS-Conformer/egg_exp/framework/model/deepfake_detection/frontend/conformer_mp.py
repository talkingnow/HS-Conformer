...
from .wenet.transformer.encoder_mp import ConformerEncoder

class ConformerMP(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
            ...
            downsample_layer=[1,3], pooling_size=4, input_seq_len=200):

        super(ConformerMP, self).__init__()
