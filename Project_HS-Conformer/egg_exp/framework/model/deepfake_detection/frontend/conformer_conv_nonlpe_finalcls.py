...
from .wenet.transformer.encoder_conv_nonlpe_finalcls import ConformerEncoder
# from wenet.transformer.encoder_conv_nonlpe_finalcls import ConformerEncoder

class ConformerConv_NonLPE_FinalCLS(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
        ...
        super(ConformerConv_NonLPE_FinalCLS, self).__init__()
...
if __name__ == '__main__':
    ...
    model = ConformerConv_NonLPE_FinalCLS().cuda()
