...
from .wenet.transformer.encoder_mp_nonlpe_finalcls import ConformerEncoder
# from wenet.transformer.encoder_mp_nonlpe_finalcls import ConformerEncoder

class ConformerMP_NonLPE_FinalCLS(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
            ...
            downsample_layer=[1,3], pooling_size=4, input_seq_len=200, add_layer_noise=False):

        super(ConformerMP_NonLPE_FinalCLS, self).__init__()
        ...
        self.conformer_mp = ConformerEncoder(input_size=bin_size, linear_units=linear_units, num_blocks=num_blocks, 
                ...
                downsample_layer=downsample_layer, pooling_size=pooling_size, input_seq_len=input_seq_len, add_layer_noise=add_layer_noise)
...
if __name__ == '__main__':
    ...
    model = ConformerMP_NonLPE_FinalCLS().cuda()
