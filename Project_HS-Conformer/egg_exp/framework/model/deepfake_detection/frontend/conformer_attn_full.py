...
from .wenet.transformer.encoder_attn_full import ConformerEncoder
# from wenet.transformer.encoder_attn_full import ConformerEncoder

class ConformerAttn_Full(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
        ...
        # attn_size == divide sequence size
        super(ConformerAttn_Full, self).__init__()
