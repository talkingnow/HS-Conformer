...
from .wenet.transformer.encoder_mp_lpe import ConformerEncoder

class ConformerMP_LPE(nn.Module):
    def __init__(self, bin_size=120, num_blocks=6, output_size=128, input_layer="conv2d2", 
            ...
            downsample_layer=[1,3], pooling_size=2, input_seq_len=200):

        super(ConformerMP_LPE, self).__init__()
        ...
        self.conformer_mp = ConformerEncoder(input_size=bin_size, linear_units=linear_units, num_blocks=num_blocks, 
                ...
                downsample_layer=downsample_layer, pooling_size=pooling_size, input_seq_len=input_seq_len)
    ...
    def forward(self, x):
        ...
        # print("first_size",x.size(), lens.size())
